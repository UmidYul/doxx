    ...
    async initChild() {
        const onComplete = new Promise((resolve, reject)=>{
            const onMessageHandler = (msg)=>{
                if (!Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$parent$2d$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ParentCommand"]).includes(msg.cmd)) {
                    return;
                }
...
class ChildProcessor {
    ...
    async start(jobJson, token) {
        ...
        this.abortController = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$abort$2d$controller$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AbortController"]();
...
class Scripts {
    ...
    async isJobInList(listKey, jobId) {
        ...
        let result;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisVersionLowerThan"])(this.queue.redisVersion, '6.0.6', this.queue.databaseType)) {
...
class Job {
     ...
     */ async moveToCompleted(returnValue, token, fetchNext = true) {
        return this.queue.trace(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SpanKind"].INTERNAL, 'complete', this.queue.name, async (span)=>{
     ...
     */ recordJobMetrics(status) {
        ...
        const attributes = {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].QueueName]: this.queue.name,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobName]: this.name,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobStatus]: status
        };
        // Record counter metric based on status
        const statusToCounterName = {
            completed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsCompleted,
            failed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsFailed,
            delayed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsDelayed,
            retried: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsRetried,
            waiting: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsWaiting,
            'waiting-children': __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobsWaitingChildren
        };
        ...
        if (this.processedOn) {
            ...
            const histogram = meter.createHistogram(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].JobDuration, {
    ...
    setSpanJobAttributes(span) {
        span === null || span === void 0 ? void 0 : span.setAttributes({
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobName]: this.name,
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobId]: this.id
        });
    }
}
...
"[project]/node_modules/bullmq/dist/esm/scripts/removeOrphanedJobs-1.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "removeOrphanedJobs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$scripts$2f$removeOrphanedJobs$2d$1$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["removeOrphanedJobs"],
    "removeRepeatable",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$scripts$2f$removeOrphanedJobs$2d$1$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/bullmq/dist/esm/scripts/removeOrphanedJobs-1.js [app-route] (ecmascript)");
    ...
    async init() {
        ...
        if (this._client['status'] !== 'end') {
            ...
            if (this.skipVersionCheck !== true && !this.closing) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisVersionLowerThan"])(this.version, RedisConnection.minimumVersion, this.dbType)) {
                    throw new Error(`Redis version needs to be greater or equal than ${RedisConnection.minimumVersion} ` + `Current: ${this.version}`);
                }
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisVersionLowerThan"])(this.version, RedisConnection.recommendedMinimumVersion, this.dbType)) {
                    console.warn(`It is highly recommended to use a minimum Redis version of ${RedisConnection.recommendedMinimumVersion}
             Current: ${this.version}`);
                }
            }
            this.capabilities = {
                canDoubleTimeout: !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisVersionLowerThan"])(this.version, '6.0.0', this.dbType),
                canBlockFor1Ms: !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisVersionLowerThan"])(this.version, '7.0.8', this.dbType)
            };
            this.status = 'ready';
        }
        return this._client;
...
class QueueEvents extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$classes$2f$queue$2d$base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueueBase"] {
    constructor(name, _a = {
        ...
        super(name, Object.assign(Object.assign({}, opts), {
            connection: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$utils$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRedisInstance"])(connection) ? connection.isCluster ? connection.duplicate(undefined, {
    ...
    */ async count() {
     ...
     */ async recordJobCountsMetric(...types) {
        ...
        if (meter && typeof meter.createGauge === 'function') {
            const gauge = meter.createGauge(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MetricNames"].QueueJobsCount, {
            ...
            for (const [state, jobCount] of Object.entries(counts)){
                gauge.record(jobCount, {
                    ...
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].QueueJobsState]: state
                });
            }
        }
        return counts;
     ...
     */ async removeOrphanedJobs(count = 1000, limit = 0) {
        ...
        do {
            ...
            const result = await this.scripts.removeOrphanedJobs([
                ...candidateJobIds
            ], stateKeySuffixes, jobSubKeySuffixes);
                    ...
                    try {
                        ...
                        if (signal) {
                            abortHandler = ()=>{
                                try {
                                    child.send({
                                        cmd: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$child$2d$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChildCommand"].Cancel,
                                        value: signal.reason
                                    });
                                } catch (_a) {
    ...
    async processJob(job, token, fetchNextCallback = ()=>true) {
        ...
        return this.trace(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SpanKind"].CONSUMER, 'process', this.name, async (span)=>{
            ...
            try {
                ...
                const now = Date.now();
                span === null || span === void 0 ? void 0 : span.setAttributes({
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobFinishedTimestamp]: now,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobAttemptFinishedTimestamp]: job.finishedOn || now,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bullmq$2f$dist$2f$esm$2f$enums$2f$telemetry$2d$attributes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelemetryAttributes"].JobProcessedTimestamp]: job.processedOn
                });
            }
...
//# sourceMappingURL=node_modules_bullmq_dist_esm_00jdbbn._.js.map