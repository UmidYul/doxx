-- Stage 2 foundation migration for the scraper-side SQLite database.
-- This file captures the first durable schema for:
-- scrape_runs -> raw_products/images/specs -> publication_outbox -> publication_attempts
